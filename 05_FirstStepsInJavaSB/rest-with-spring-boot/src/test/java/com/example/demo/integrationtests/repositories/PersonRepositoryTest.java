...
public class PersonRepositoryTest extends AbstractIntegrationTest {
	...
	public void testFindByName() throws JsonMappingException, JsonProcessingException {
	    ...
	    assertNotNull(person.getId()); assertNotNull(person.getFirstName());
	    assertNotNull(person.getLastName()); assertNotNull(person.getAddress());
	    ...
	    assertEquals("Ayrton", person.getFirstName()); assertEquals("Senna",
	    person.getLastName()); assertEquals("São Paulo", person.getAddress());
