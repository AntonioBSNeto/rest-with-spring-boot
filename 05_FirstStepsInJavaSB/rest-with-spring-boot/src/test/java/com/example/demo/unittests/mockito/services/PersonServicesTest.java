...
class PersonServicesTest {
	...
	/*
	 * @Test void testFindAll() { List<Person> list = input.mockEntityList();
	 * 
	 ...
	 * 
	 * assertNotNull(peopleOne); assertNotNull(peopleOne.getKey());
	 * assertNotNull(peopleOne.getLinks());
	 * 
	 * assertTrue(peopleOne.toString().
	 ...
	 * 
	 * assertNotNull(peopleFour); assertNotNull(peopleFour.getKey());
	 * assertNotNull(peopleFour.getLinks());
	 * 
	 * assertTrue(peopleFour.toString().
	 ...
	 * 
	 * assertNotNull(peopleSeven); assertNotNull(peopleSeven.getKey());
	 * assertNotNull(peopleSeven.getLinks());
	 * 
	 * assertTrue(peopleSeven.toString().
