...
public class PersonController {
	...
	@Operation(summary = "Finds people by name", description = "Find People by Name",
	tags = {"People"},
	responses = {
			@ApiResponse(description = "Success", responseCode = "200",
					content = {
	...
	public PersonVO disablePersonn(@PathVariable(value = "id") Long id) {
		return service.disbablePerson(id);
	}
